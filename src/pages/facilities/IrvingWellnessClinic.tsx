...
import facilityImage from '@/assets/irving-wellness-1.jpg';
...
const IrvingWellnessClinic = () => {
  return (
    <Layout>
      <SEOHead
        title="Irving Health & Wellness Clinic | Weight Loss, HRT, Aesthetics in Irving, TX"
        description="Irving Health & Wellness Clinic offers physician-supervised medical weight loss (Semaglutide, Tirzepatide), hormone replacement therapy, Botox, IV hydration, body contouring & preventive wellness in Irving, TX. Serving Las Colinas, Valley Ranch & DFW."
        canonicalUrl="/facilities/irving-wellness-clinic"
        keywords="wellness clinic Irving TX, medical weight loss Irving, Semaglutide Irving TX, Tirzepatide Las Colinas, hormone replacement therapy Irving, Botox Irving TX, IV hydration therapy DFW, body contouring Irving, aesthetic clinic Las Colinas, preventive wellness Irving Texas, HRT Irving TX, Focus Health"
      />
      <Helmet>
        <script type="application/ld+json">{JSON.stringify(irvingWellnessSchema)}</script>
