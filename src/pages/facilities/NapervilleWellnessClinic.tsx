...
import facilityImage from '@/assets/naperville-wellness-1.jpg';
...
const NapervilleWellnessClinic = () => {
  return (
    <Layout>
      <SEOHead
        title="Naperville Health & Wellness Clinic | Weight Loss, HRT, Aesthetics in Naperville, IL"
        description="Naperville Health & Wellness Clinic offers physician-supervised medical weight loss (Semaglutide, Tirzepatide), hormone replacement therapy, Botox, IV hydration, body contouring & preventive wellness in Naperville, IL. Serving Aurora, Wheaton & Chicago suburbs."
        canonicalUrl="/facilities/naperville-wellness-clinic"
        keywords="wellness clinic Naperville IL, medical weight loss Naperville, Semaglutide Naperville IL, Tirzepatide Aurora, hormone replacement therapy Naperville, Botox Naperville IL, IV hydration therapy Chicago suburbs, body contouring Naperville, aesthetic clinic Aurora, preventive wellness Naperville Illinois, HRT Naperville IL, Focus Health"
      />
      <Helmet>
        <script type="application/ld+json">{JSON.stringify(napervilleWellnessSchema)}</script>
            ...
            <ScrollReveal>
              <div>
                ...
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  ...
                  <p>
                    Proudly serving <strong>Naperville, Aurora, Wheaton, Lisle, Bolingbrook</strong>, and the greater <strong>Chicago suburban area</strong>, Naperville Health & Wellness Clinic is operated by <Link to="/" className="text-primary hover:underline font-medium">Focus Health</Link> — a healthcare infrastructure company committed to building and managing high-quality healthcare facilities.
                  </p>
                </div>
