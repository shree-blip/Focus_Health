...
const PartnersPage = () => {
  ...
  const handlePartnerTypeChange = (type: string, checked: boolean) => {
    if (checked) {
      setFormData({ ...formData, partnerType: [...formData.partnerType, type] });
    } else {
      setFormData({ ...formData, partnerType: formData.partnerType.filter(t => t !== type) });
    }
  };
  ...
  return (
    <Layout>
      ...
      <PageHero
        ...
        description="Investing in Freestanding Emergency Room Clinics — End to End Turnkey Healthcare Solutions. Buy and own a turn-key ER location or partner with Focus Health for comprehensive management support."
        backgroundImage={heroPartners}
        primaryCta={{ text: "Request More Info", link: "#opportunity-form" }}
      />
        ...
        <div className="container-focus">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {investmentOptions.map((option, index) => (
              <ScrollReveal key={option.title} delay={index * 0.15} direction={index === 0 ? 'right' : 'left'}>
                <motion.div
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">Strategic locations in high-growth DFW, Houston, Austin, and San Antonio metros.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                  ...
                  <div className="space-y-5">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        value={formData.marketInterest}
                        onChange={(e) => setFormData({ ...formData, marketInterest: e.target.value })}
                        className="h-12"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value) => setFormData({ ...formData, cashToInvest: value })}
                        required
                      >
                        ...
                        <SelectContent>
                          {cashToInvestOptions.map((option) => (
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-4">
                        {['Physician/Doctor', 'Investor', 'Other'].map((type) => (
                    ...
                    <div>
                      ...
                      <Textarea
                        id="additionalInfo"
                        placeholder="Tell us about your investment goals, experience, or any questions..."
